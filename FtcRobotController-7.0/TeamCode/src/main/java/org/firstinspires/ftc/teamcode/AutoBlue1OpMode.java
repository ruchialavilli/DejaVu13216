...
public class AutoBlue1OpMode extends BaseAutoOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        telemetry.update();
        driveForwardByInches(-14/2,  DejaVuBot.TPS);
        ...
        driveForwardByInches(37,  DejaVuBot.TPS);
        turnToPID(-90);
        telemetry.addData(name, " Driving to wall ");
        telemetry.update();

        driveForwardByInches(-34,  DejaVuBot.TPS);
        driveForwardByInches(-2,  DejaVuBot.TPS/2);
        spinForOneDuck( true);
        driveForwardByInches(21,  DejaVuBot.TPS);
        turnToPID(90);
